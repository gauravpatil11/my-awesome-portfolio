        ...
        <div class="container px-5 py-24 mx-auto">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 md:w-1/3 sm:w-full">
              <div class="h-full bg-transparent hover:bg-purple-600 border-2 border-purple-500 bg-opacity-75 px-8 py-8 rounded-lg overflow-hidden text-center relative">
            ...
            <div class="p-4 md:w-1/3 sm:w-full">
              <div class="h-full bg-transparent border-2 border-purple-500 bg-opacity-75 px-8 py-8 rounded-lg overflow-hidden text-center relative">
                <h2 className="text-2xl title-font font-medium mb-4">
                  Portfolio Websites
                </h2>
                <p class="leading-relaxed text-base">
            ...
            <div class="p-4 md:w-1/3 sm:w-full">
              <div className="h-full bg-transparent border-2 border-purple-500 bg-opacity-75 px-8 py-8 rounded-lg overflow-hidden text-center relative">
                <h2 className="text-2xl title-font font-medium mb-4">
